...
public class MultiEndpointServerSample {
	...
	public static void main(String[] args) throws Exception {
		...
		Resource jettyApplicationContextResource1 = new UrlResource(MultiEndpointServerSample.class.getResource("jetty-applicationContext1.xml"));
		Resource jettyApplicationContextResource2 = new UrlResource(MultiEndpointServerSample.class.getResource("jetty-applicationContext2.xml"));
		Resource jettyApplicationContextResource3 = new UrlResource(MultiEndpointServerSample.class.getResource("jetty-applicationContext3.xml"));
